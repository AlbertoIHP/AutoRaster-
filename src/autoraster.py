...
if __name__ == '__main__':
	...
	#y con eso se generara un arreglo de direcciones de cada uno de los archivos tiff encontrados desde el directorio tope
		...
		resultPath = "D:\imagenes"
		#totalArchivos = listDirMaker("D:\IMAGENES LANDSAT\Imagenes\INVIERNO (2010-2015)\Bulk Order 681942\L7 ETM_ SLC-off _2003-present_\LE72330862014225EDC00").getdirList()
		#totalArchivos = listDirMaker("D:\IMAGENES LANDSAT\Imagenes\OTONO(2010-2015)\Bulk Order 681941\L7 ETM_ SLC-off _2003-present_\LE72330862011121ASN00").getdirList()
		...
		for indice in range(len(totalArchivos)):
			try:
				...
				if(indice == 0):
					newDir = resultPath+"\\"+currentRaster.name
					try:
				...
				print (indice+1)," de ",totalArchivos.__len__()," completados"
				lastRaster = currentRaster
			except IndexError:
				print "La imagen"+currentRaster.name+", presento el siguiente problema ",IndexError
